    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(4.dp)) {
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                Text(text = "${activity.type} · ${Formatters.formatDateTime(activity.timestamp)}", style = MaterialTheme.typography.titleMedium)
            ...
            activity.steps?.let { Text("Langkah: ${Formatters.formatSteps(it)}") }
